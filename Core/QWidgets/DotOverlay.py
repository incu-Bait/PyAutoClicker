...
class ScreenDotOverlay(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter.drawLine(widget_x - DotOverlay_Configs.CROSSHAIR_LENGTH, widget_y, 
                        widget_x + DotOverlay_Configs.CROSSHAIR_LENGTH, widget_y)
        painter.drawLine(widget_x, widget_y - DotOverlay_Configs.CROSSHAIR_LENGTH,
                        widget_x, widget_y + DotOverlay_Configs.CROSSHAIR_LENGTH)
        
        painter.setPen(QPen(self.dot_color, DotOverlay_Configs.DOT_THICKNESS))
        painter.setBrush(self.dot_color)
        painter.drawEllipse(widget_x - DotOverlay_Configs.DOT_RADIUS,
        ...
        painter.drawEllipse(widget_x - DotOverlay_Configs.CENTER_RADIUS,
